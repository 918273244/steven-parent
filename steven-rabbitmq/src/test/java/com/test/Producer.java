...
public class Producer {
    ...
    public static void main(String[] args) {
        ...
        factory.setHost("192.168.1.129"); //使用默认端口连接本地rabbitmq服务器
            ...
            switch (xt){
                case DEFAULT:
                    ...
                    while (GetInputString()) {
                        ...
                        channel.basicPublish("", QUEUE_NAME, MessageProperties.PERSISTENT_TEXT_PLAIN, message.getBytes()); //设置消息为持久化，服务器重启不会丢
